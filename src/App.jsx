...
function PortfolioTracker({ password, onLogout, onAuthFail }) {
  ...
  // Collapsed state for the holdings section
      ...
      >
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          {holdings.length === 0 ? (
            ...
            <>
              {/* Collapse toggle for the entire holdings section */}
              <button
                ...
                style={{
                  ...
                  borderRadius: 4,
                  padding: "14px 16px",
                  marginBottom: holdingsCollapsed ? 0 : 12,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "space-between",
                  color: T.text,
              ...
              >
                ...
                <ChevronDown
                  ...
                  style={{
                    color: T.textDim,
                    transform: holdingsCollapsed ? "rotate(-90deg)" : "none",
                    transition: "transform 0.2s",
                  }}
                />
              </button>
